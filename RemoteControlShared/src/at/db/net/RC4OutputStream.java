...
public class RC4OutputStream extends OutputStream {
	...
	/*
	 * private byte[] encrypt(final byte[] plaintext) { final byte[] ciphertext =
	 * new byte[plaintext.length]; int i = 0, j = 0, k, t; for (int counter = 0;
	...
	public RC4OutputStream(OutputStream out, byte[] key) {
		this.out = out;
