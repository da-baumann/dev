...
public class KeyboardLayoutLinuxDe implements IKeyboardLayout {
	...
	public int[] getKeyCodes(char character) {
		...
		case '!':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_EXCLAMATION_MARK };
		case ';':
		...
		case '`':
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_DEAD_CIRCUMFLEX };
		case '"':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_QUOTEDBL };

			// Brackets
		case '(':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_LEFT_PARENTHESIS };
		case ')':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_RIGHT_PARENTHESIS };
		case '[': /* VK_DEAD_DIAERESIS | VK_DEAD_ABOVERING */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_DEAD_DIAERESIS };
		case ']': /* VK_DEAD_TILDE | VK_DEAD_MACRON | VK_ASTERISK | VK_PLUS */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_DEAD_TILDE };
		case '{': /* VK_DEAD_DIAERESIS | VK_DEAD_ABOVERING */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_SHIFT, KeyEvent.VK_DEAD_DIAERESIS };
		case '}': /* VK_DEAD_TILDE | VK_DEAD_MACRON | VK_ASTERISK | VK_PLUS */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_SHIFT, KeyEvent.VK_DEAD_TILDE };

			// German special characters
		case 'ä':
			return new int[] { KeyEvent.VK_DEAD_CARON };
		case 'ö':
			return new int[] { KeyEvent.VK_DEAD_DOUBLEACUTE };
		case 'ü':
			return new int[] { KeyEvent.VK_DEAD_ABOVERING };
		case 'Ä':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_DEAD_CARON };
		case 'Ö':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_DEAD_DOUBLEACUTE };
		case 'Ü':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_DEAD_ABOVERING };
		case 'ß':
		...
		case '>':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_GREATER };
		case '#':
			return new int[] { KeyEvent.VK_NUMBER_SIGN };
		case '%':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_5 };
		case '$':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_DOLLAR };
		case '€':
			return new int[] { /* KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_EURO_SIGN */};
			

			// General typography
		case '~': /* VK_DEAD_CIRCUMFLEX | VK_BACK_QUOTE */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_SHIFT, KeyEvent.VK_DEAD_CIRCUMFLEX };
		case '@':
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_SHIFT, KeyEvent.VK_QUOTEDBL };
		case '^': /* VK_CIRCUMFLEX | VK_AMPERSAND */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_SHIFT, KeyEvent.VK_CIRCUMFLEX };
		case '°':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_CIRCUMFLEX };
		case '§':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_3 };
		case '&':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_AMPERSAND };
		case '_':
			return new int[] { KeyEvent.VK_SHIFT, KeyEvent.VK_UNDERSCORE };
		case '\\': /* VK_DEAD_BREVE, VK_QUOTE, VK_NUMBER_SIGN */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_DEAD_BREVE };
		case '|': /* VK_DEAD_BREVE | VK_QUOTE | VK_NUMBER_SIGN */
			return new int[] { KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_SHIFT, KeyEvent.VK_DEAD_BREVE };
		}
