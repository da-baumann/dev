...
public class IntentIntegrator {
	...
	/**
	 * Initiates a scan only for a certain set of barcode types, given as strings
	 * corresponding to their names in ZXing's {@code BarcodeFormat} class like
	 * "UPC_A". You can supply constants like {@link #PRODUCT_CODE_TYPES} for
	 * example.
	 * 
	 ...
	 *         else an {@link IntentResult} containing the result of the scan. If
	 *         the user cancelled scanning, the fields will be null.
	 */
	 ...
	 *          {@code com.google.zxing.client.android.Contents.Type} constants.
	 * @return the {@link AlertDialog} that was shown to the user prompting them
	 *         to download the app if a prompt was needed, or null otherwise
	 */
